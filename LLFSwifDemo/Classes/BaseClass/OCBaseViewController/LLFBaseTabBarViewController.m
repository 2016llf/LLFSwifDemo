...
- (void)viewDidLoad {
    ...
    [self setChildViewControllerWith:[[LLFOneViewController alloc]init] :@"首页" :@"bs_hui" :@"bs_red"];
    [self setChildViewControllerWith:[[LLFTwoViewController  alloc]init] :@"发现" :@"bs_hui" :@"bs_red"];
    [self setChildViewControllerWith:[[LLFThreeViewController alloc]init] :@"消息" :@"bs_hui" :@"bs_red"];
    [self setChildViewControllerWith:[[LLFFourViewController alloc]init] :@"我的" :@"bs_hui" :@"bs_red"];
}
